            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Helmy
                                Dianty Putri</a>
                        </li>
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">DSS SAW</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">DSS SAW</h6>
                </nav>
        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
            ...
            <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('skala') ? 'active' : '' }}"
                            href="{{ route('skala.index') }}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('bobot') ? 'active' : '' }}"
                                    ...
                                    <div
                                        ...
                                        <div class="cursor-pointer">
                                            <div class="full-background"
                                                style="background-image: url({{ asset('assets/img/curved-images/curved1.jpg') }})">
                                            </div>
                                            <div class="card-body">
            ...
            <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <div class="copyright text-center text-sm text-muted text-lg-start">
                        ...
                        made with <i class="fa fa-heart"></i> by Helmy Dianty Putri
                        for a better web.
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow-lg ">
            <div class="card-header pb-0 pt-3 ">
                <div class="float-start">
                    <h5 class="mt-3 mb-0">Helmy Dianty Putri</h5>
